...
const FooButton = ({
  ...
  return (
    ...
    transition-all duration-700  before:absolute before:h-0 before:w-0 before:rounded-full tracking-[3px]
     before:duration-700 before:ease-out  hover:before:h-56 hover:before:w-56 font-dimensions text-[35px] md:text-[42px]  font-light
